...
define([
	...
	"axios",
	"kwe.filemanager",
	"kwe.filemanagement.remotefilesystemprovider",
	"dx",
	...
	*/
	...
	var WorkBench=function(options){
		...
		{//basic usage
			...
			//https://js.devexpress.com/Documentation/ApiReference/UI_Components/dxFileManager/File_System_Providers/Remote/
			var provider=new DevExpress.fileManagement.RemoteFileSystemProvider({
			//var provider=new DevExpress.fileProviders.Remote({//19.2.7
...
/*
provider._executeRequest=function(command, args) {
	var method="POST";
	var url=this._getEndpointUrl(command, args);
...
*/
			_provider=new KweRemotefilesystemprovider({
				endpointUrl: options.svcpath
			});
